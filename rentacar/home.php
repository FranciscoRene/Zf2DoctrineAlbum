...
<div class="box">
				<div class="h_title">&#8250; Gráficos</div>
				<ul>
					<li class="b1"><a class="icon page" href="?modulo=graficos&opcion=vehiculos">Vehiculos Arrendados</a></li>
					<li class="b2"><a class="icon page" href="?modulo=graficos&opcion=clientes">Arriendos Clientes</a></li>
					<li class="b2"><a class="icon page" href="?modulo=graficos&opcion=meses">Arriendos Mensuales</a></li>
					<li class="b2"><a class="icon page" href="?modulo=graficos&opcion=dias">Arriendos Diarios</a></li>
...
<div class="full_w">	
	<div class="h_title">Accesos Directos</div>
		...
		<div id="box_home_icono" style="padding-left:60px;">
			<ul>
			...
			<li><a href="?modulo=arriendos&opcion=agregar"><img src="img/iconos/calendario.png" width="128" hight="128"><h3>Generar Arriendo</h3></a></li>
...
<?php  } ?>
<div class="full_w" id="main">
<?php  
	// RECIBE NOMBRE DE  MODULOS PRINCIPALES
	$id = $_GET['modulo'];

	switch($id) {
	case 'clientes':
	include("mod_clientes.php");
	break;

	case 'vehiculos':
	include("mod_vehiculos.php");
	break;

	case 'serv_tecnico':
	if ($_SESSION['usuario_perfil']==1) {
	include("mod_serv_tecnicos.php");
	} else
		echo "No tiene permisos";
	break;

	case 'arriendos':
	include("mod_arriendos.php");
	break;

	case 'detalle_arriendo':
	include("mod_detalle_arriendo.php");
	break;

	case 'mantenciones':
	include("mod_mantenciones.php");
	break;

	case 'informes':
	if ($_SESSION['usuario_perfil']==1) {
	include("mod_informes.php");
	} else 
		echo "No tiene Permisos";
	break;
